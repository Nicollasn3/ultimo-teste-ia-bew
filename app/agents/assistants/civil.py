...
class CivilAgent(BaseAgent):
    ...
    - Direito Civil (111 docs)
    - Direito de Família (3 docs)
    - Alienação Parental (23 docs)
    - Direito de Seguros (1 doc)
    - Dano Moral/Assédio Moral (5 docs)
    ...
    def __init__(self, retriever: Optional[Any] = None):
        self.name = "Especialista_Civil"
        self.model = "gpt-4o-mini"
        self.instructions = SPECIALIST_PROMPTS_BY_AREA["civil"]
    ...
    def create_agent(self) -> Agent:
        return Agent(
            name=self.name,
            handoff_description="Especialista em Direito Civil (Brasil) - Obrigações, Contratos, Responsabilidade Civil, Família, Danos Morais",
    ...
    async def run_with_trace(self, query, history=None):
        with trace("agente_especialista_civil"):
